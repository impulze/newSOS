...
public class EReportingAssessmentTypeDAO {
    public List<EReportingAssessmentType> getEReportingAssessmentTypes(Session session) {
    	return CollectionHelper.list(getEReportingAssessmentType(AssessmentType.Fixed, session));
    }
    ...
    public EReportingAssessmentType getEReportingAssessmentType(AssessmentType assessmentType, Session session) {
    	if (!assessmentType.equals(AssessmentType.Fixed)) {
    		throw new RuntimeException("Only AQD assessement type 'Fixed' supported.");
    	}

    	final EReportingAssessmentType eReportingAssessmentType = new EReportingAssessmentType();
    ...
    public EReportingAssessmentType getEReportingAssessmentType(String assessmentType, Session session) {
    	return getEReportingAssessmentType(AssessmentType.fromId(assessmentType), session);
    }
}